...
public class Configurations {
    public class Messages {
        ...
        public Messages(YamlConfiguration config) {
            ...
            notifyMessage = Utils.colorize(config.getString("notifications.notification-message"));}
    }
    ...
    public class Settings {
        ...
        public final Boolean notifyConsole;
        ...
        public Settings(YamlConfiguration config) {
            ...
            punishmentEnabled = config.getBoolean("punishment.enable");
            punishmentCommand = config.getString("punishment.command");
            punishmentDisallowEntry = config.getBoolean("punishment.disallow-entry");
            notificationsEnabled = config.getBoolean("notifications.enable");
            notifyConsole = config.getBoolean("notifications.console");
        }
    }
}
